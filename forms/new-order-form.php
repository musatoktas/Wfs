...
<input type="submit" name="test1" id="test1" value="RUN" /><br/>
<script>
...
$.ajax({
    type: 'POST',
    url: 'https://ssapi.shipstation.com/orders?customerName=headhoncho@whitehouse.gov&page=1&pageSize=7',
